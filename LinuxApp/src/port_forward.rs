//! Lokal portvidarebefordran (`ssh -L`), motsvarigheten till
//! `Sources/SSHCore/PortForward.swift`s `openLocalPortForward`. En lokal
//! TCP-lyssnare bryggar varje ansluten klient till en egen `direct-tcpip`-
//! SSH-kanal via russh (samma RFC 4254-mekanism som Swift/CLI-sidan).
//!
//! Fjärr- (`-R`) och dynamisk (`-D`, SOCKS5) vidarebefordran är INTE
//! byggda än — se ROADMAP.md, samma "vyerna finns inte än"-avgränsning
//! som resten av LinuxApp/.
