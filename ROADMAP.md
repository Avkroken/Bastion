...
| ssh-config-parsing (`Host`-alias, jokertecken, `IdentityFile`, `Include`) | ✅ testad, CLI slår upp alias — `Include` i LinuxApp Rust (2026-08-19), ännu inte i Swift-sidans `SSHConfig.swift` |
