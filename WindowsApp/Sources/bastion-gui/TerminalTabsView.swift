...
/// ROADMAP.md) — flikbyte sker via knapptryck. LinuxApp har därutöver en
/// riktig touchscreen-svep-gest via `GestureSwipeBridge.swift`, kopplad
/// direkt mot GTK4:s `GtkGestureSwipe` (rå GLib-signaler) — ingen
/// motsvarighet portad hit, WinUIBackend har ingen egen pekar-/
/// manipulationshändelse-API exponerad i `.inspect()` ännu. Den saknar
